...
| :--- | :--- | :--- |
| 🌍 **[TAMRFSITS Change Detection](https://github.com/RomainCrgnl/ProjetTAMRFSITS_RemoteSensingMVA)** | Predictive change detection on Sentinel-2 satellite time series using TAMRFSITS. | `Python` |
